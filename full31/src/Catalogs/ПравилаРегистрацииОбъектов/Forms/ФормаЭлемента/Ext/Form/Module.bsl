...
Процедура КД3_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	Обработчики.Добавить("АлгоритмПриОбработкеДополнительныйПравила", "OnRuleProcessingAdditional");
	Обработчики.Добавить("АлгоритмПриОбработкеПравила", "OnRuleProcessing");
