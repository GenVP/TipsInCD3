...
&НаКлиенте
Асинх Процедура КД3_Подключаемый_КаталогИндексовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	ДиалогВыбора = Новый ДиалогВыбораФайла(РежимДиалогаВыбораФайла.ВыборКаталога);
	ДиалогВыбора.Каталог = ЭтотОбъект.КД3_КаталогИндексов;
	
	Результат = ДиалогВыбора.ВыбратьАсинх();
...
Процедура КД3_Подключаемый_ЗагрузитСтруктуруКонфигурации(Команда)
	...
	ОткрытьФорму("Обработка.КД3_ЗагрузкаСтруктурыКонфигурацииИзФайловXMLМногопоточно.Форма", СтруктураПараметров);
