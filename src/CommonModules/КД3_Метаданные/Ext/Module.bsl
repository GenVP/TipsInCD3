...
Функция ИнициализацияПараметровЗагрузкиИзФайла(Конфигурация)
	...
	РеквизитыКонфигурации = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Конфигурация, "ИсточникДанных,КаталогЗагрузки,Расширения");
	...
	ПараметрыЗагрузки.Вставить("Расширения", РеквизитыКонфигурации.Расширения);
...
Функция ЗагрузитьКоллекциюОбъектовИзФайлов(Конфигурация, ИмяКоллекции)
	...
	КлючКоллекции = КД3_ЗагрузкаМетаданных.ОбработатьГруппуОбъектов(ПараметрыЗагрузки, ИмяКоллекции);
...
Функция ЗагрузитьОбъектИзФайла(Конфигурация, ИмяКоллекции, ИмяОбъекта)
	...
	КлючКоллекции = КД3_ЗагрузкаМетаданных.ОбработатьОбъект(ПараметрыЗагрузки, ИмяКоллекции, ИмяОбъекта);
...
Функция ЗагрузитьМодульОбъектаИзФайла(Конфигурация, ВидМодуля, КорневойТип, ИмяОбъекта)
	...
	КлючКоллекции = КД3_ЗагрузкаМетаданных.ЗагрузитьМодульОбъекта(ПараметрыЗагрузки, Конфигурация, ВидМодуля, КорневойТип, ИмяОбъекта);
