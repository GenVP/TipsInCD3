...
Функция ЗагрузитьНастройки() Экспорт
	...
	Настройки.Вставить("Тема", ХранилищеОбщихНастроек.Загрузить("КД3_Настройки", "Тема"));
	Настройки.Вставить("НеЗагружатьМетаданные", ХранилищеОбщихНастроек.Загрузить("КД3_Настройки", "НеЗагружатьМетаданные"));
	Настройки.Вставить("НеОтображатьКартуКода", ХранилищеОбщихНастроек.Загрузить("КД3_Настройки", "НеОтображатьКартуКода"));
...
Процедура СохранитьНастройки(Настройки) Экспорт
	...
	ХранилищеОбщихНастроек.Сохранить("КД3_Настройки", "Тема", Настройки.Тема);
	ХранилищеОбщихНастроек.Сохранить("КД3_Настройки", "НеЗагружатьМетаданные", Настройки.НеЗагружатьМетаданные);
	ХранилищеОбщихНастроек.Сохранить("КД3_Настройки", "НеОтображатьКартуКода", Настройки.НеОтображатьКартуКода);
