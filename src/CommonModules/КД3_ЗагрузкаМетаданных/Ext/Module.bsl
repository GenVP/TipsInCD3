...
Функция ОбработатьГруппуОбъектов(ПараметрыЗагрузки, ИмяКоллекции) Экспорт
	...
	Возврат КлючКоллекции;
	
КонецФункции

Функция ОбработатьОбъект(ПараметрыЗагрузки, ИмяКоллекции, ИмяОбъекта) Экспорт
...
Функция ЗагрузитьМодульОбъекта(ПараметрыЗагрузки, Конфигурация, ВидМодуля, КорневойТип, ИмяОбъекта) Экспорт
